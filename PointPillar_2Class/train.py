...
def main(args):
    ...
    for epoch in range(0, args.max_epoch):
        ...
        for i, data_dict in enumerate(tqdm(train_dataloader)):
            ...
            # print(bbox_cls_pred.shape, bbox_pred.shape, bbox_dir_cls_pred.shape, batched_bbox_labels.shape, batched_label_weights.shape, batched_bbox_reg.shape, batched_dir_labels.shape)
            
            pos_idx = (batched_bbox_labels >= 0) & (batched_bbox_labels < args.nclasses)

            # print(pos_idx.shape, bbox_pred.shape)
