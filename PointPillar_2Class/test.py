...
#     print("pc shape: ", pc.shape)
    ...
    vis_pc(pc, pred_bboxes=lidar_bboxes, pred_labels=labels)
    # vis_pc(pc, bboxes=lidar_bboxes, labels=labels)
    
    
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Configuration Parameters')
    parser.add_argument('--ckpt', default='pillar_logs/checkpoints/treedata_epoch_140.pth', help='checkpoint for kitti')
#     parser.add_argument('--ckpt')
    parser.add_argument('--pc_path', default='/home/abhishek/Desktop/Work/TreeDetection/TreeData_bin/testing/velodyne/sub_23_plot_920_points.bin', help='point cloud path')
    parser.add_argument('--gt_path', default='/home/abhishek/Desktop/Work/TreeDetection/TreeData_bin/testing/label_2/sub_10_plot_438_bbox.txt', help='ground truth path')
